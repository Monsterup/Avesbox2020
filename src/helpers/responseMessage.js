...
exports.sendVerifyEmail = (url, token, cb) => `
                                                    ...
                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <img class="max-width" border="0"
                                                                ...
                                                                width="200" alt="" data-proportionally-constrained="true"
                                                                data-responsive="false"
                                                                src="https://res.cloudinary.com/djqhuzw82/image/upload/v1588766666/logo_with_tagline_sobdme.png"
                                                                >
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      ...
                                                      <table class="module" role="module" data-type="text" border="0"
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              style="padding:50px 30px 0px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                      ...
                                                      <table class="module" role="module" data-type="text" border="0"
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              style="padding:0px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;"
                                                              height="100%" valign="top" bgcolor="#ffffff"
                                                              role="module-content">
                                                              <div>
                                                                <div style="font-family: inherit;">
                                                                  <span style="font-size: 20px">Klik tautan di bawah untuk memverifikasi akun Anda : </span>
                                                                </div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                                  ...
                                                                  <tr>
                                                                    <td align="center" bgcolor="#ffbe00"
                                                                      ...
                                                                      <a href="${url}/${token}"
                                                                        ...
                                                                        target="_blank">Verikasi Email</a>
                                                                    </td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Jika Anda tidak membuat akun, silahkan abaikan email ini</span>
                                                                </div>
                                                                <br/>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #ffbe00; font-size: 18px"><strong>Terima
                                                                      Kasih!&nbsp;</strong></span></div>
                                                                <div></div>
                                                                <br/>
                                                                <hr/>
                                                                <br/>
                                                                <div style="font-family: inherit;">
                                                                  <span style="font-size: 12px">Jika tautan "Verifikasi email" tidak bisa diklik, copy dan paste URL di bawah ini ke web browser anda : </span>
                                                                </div>
                                                                <div style="font-family: inherit;">
                                                                    <span style="font-size: 12px">${url}/${token}</span>
                                                                  </div>
                                                              </div>
                                                            </td>
                                                          </tr>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit;">
                                                                  <span style="font-size: 20px">Berikut kode OTP Anda : </span>
                                                                </div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Jika Anda merasa tidak merubah email / password, silahkan abaikan email ini</span>
                                                                </div>
                                                                <br/>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
